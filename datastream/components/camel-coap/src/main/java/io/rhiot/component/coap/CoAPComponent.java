 ...
 */
public class CoAPComponent extends UriEndpointComponent {
    ...
    protected Endpoint createEndpoint(String uri, String remaining, Map<String, Object> parameters) throws Exception {
        ...
        URI coapUri = URISupport.createRemainingURI(new URI(uri), parameters);

        parameters.put(CoAPConstants.COAP_URI_ATTRIBUT, coapUri);
        setProperties(endpoint, parameters);
