...
docker run --name cloudlet-device -d --link mongodb:mongodb -p 15000:15000 -e XMX=128m rhiot/cloudlet-device

### Geofencing Cloudlet
docker rm cloudlet-geofencing
docker pull rhiot/cloudlet-geofencing
docker run -d --name cloudlet-geofencing --link mongodb:mongodb -p 15001:15001 -e XMX=128m rhiot/cloudlet-geofencing
