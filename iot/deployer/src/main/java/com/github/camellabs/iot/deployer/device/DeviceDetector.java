...
import static com.github.camellabs.iot.deployer.device.Device.DEVICE_RASPBERRY_PI_2;
...
public class DeviceDetector {
    ...
    private final static Logger LOG = getLogger(DeviceDetector.class);
    ...
    public DeviceDetector(int timeout) {
