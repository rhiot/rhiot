 ...
 */
package org.apache.camel.labs.test.raspberrypi.output;
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                from("timer://foo?repeatCount=1").id("rbpi-route").to("log:org.apache.camel.labs.labs.component.raspberrypi?showAll=true&multiline=true").transform().constant(true)
