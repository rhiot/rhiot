 ...
 */
package org.camellabs.labs.test.raspberrypi.input;
...
import org.camellabs.component.raspberrypi.RaspberryPiConsumer;
import org.camellabs.labs.component.raspberrypi.mock.RaspiGpioProviderMock;
...
public class DigitalInput2Test extends CamelTestSupport {
    ...
    public void consumeDigitalEvent() throws Exception {
        ...
        RaspberryPiConsumer consumer = (RaspberryPiConsumer)this.context.getRoute("test-route").getConsumer();
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            public void configure() {
                from("raspberrypi://pin/0?mode=DIGITAL_INPUT&state=LOW").id("test-route").to("mock:result");
