 ...
 */
package org.camellabs.component.raspberrypi;
...
public class RaspberryPiConsumer extends DefaultConsumer implements GpioPinListenerDigital, GpioPinListenerAnalog {
    ...
    public void handleGpioPinAnalogValueChangeEvent(GpioPinAnalogValueChangeEvent event) {
        ...
        exchange.getIn().setHeader(RaspberryPiConstants.CAMEL_RBPI_PIN, event.getPin());
        exchange.getIn().setHeader(RaspberryPiConstants.CAMEL_RBPI_PIN_VALUE, event.getValue());
        exchange.getIn().setHeader(RaspberryPiConstants.CAMEL_RBPI_PIN_TYPE, event.getEventType());
    ...
    public void handleGpioPinDigitalStateChangeEvent(GpioPinDigitalStateChangeEvent event) {
        ...
        exchange.getIn().setHeader(RaspberryPiConstants.CAMEL_RBPI_PIN, event.getPin());
        exchange.getIn().setHeader(RaspberryPiConstants.CAMEL_RBPI_PIN_STATE, event.getState());
        exchange.getIn().setHeader(RaspberryPiConstants.CAMEL_RBPI_PIN_TYPE, event.getEventType());
